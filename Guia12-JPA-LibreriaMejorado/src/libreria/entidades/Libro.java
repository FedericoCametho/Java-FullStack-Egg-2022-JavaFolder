...
public class Libro implements Serializable {
    ...
    public Libro(String tit, Integer ejemplares, Integer ejemplaresPrestados, Autor au, Editorial ed){
        this.titulo = tit;
        this.ejemplares = ejemplares;
        this.ejemplaresPrestados = ejemplaresPrestados;
        this.ejemplaresRestantes = this.ejemplares - this.ejemplaresPrestados;
        this.alta = this.ejemplaresRestantes > 0;
        this.autor = au;
        this.editorial = ed;
    }
    ...
    public void setEjemplaresPrestados(Integer ejemplaresPrestados) {
        ...
        this.alta = ejemplaresRestantes > 0;
    }
